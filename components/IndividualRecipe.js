...
function IndividualRecipe(props) {
  ...
  const currentActive = useSelector(state => state.singleRecipe.currentActive);
            ...
            <ScrollView>
              <View style={styles.recipeContainer}>
                ...
                <View style={styles.titleWrapper}>
                  <Title title={recipe.title} currentActive={currentActive} />
                </View>
                ...
                <View style={styles.tagBox}>
                  {recipe.tags &&
                    recipe.tags.map(cat => (
                      <Text key={cat.id} style={styles.individualTags}>
                        {cat.name}
                      </Text>
                    ))}
                </View>
                ...
                <View style={styles.recipeDetails}>
                  {color.active === "Ingredients" && (
                    <>
                      ...
                      <AddIngredient currentActive={currentActive} />
                    </>
                  )}
              ...
              <View>
                  ...
                  <View style={styles.tagRow}>
                    {recipe.tags &&
                      recipe.tags.map((tag, index) => (
                        <Text key={tag.id} style={styles.individualTags}>
                          {tag.name}
                ...
                <View style={styles.versionHistoryContainer}>
                  {hasRevisions() && (
                    <TouchableOpacity
                      onPress={() =>
                        props.navigation.navigate("VersionHistoryList", {
                          parentId: id,
                        })
                      }>
                      <Text style={styles.versions}>Previous Versions</Text>
                    </TouchableOpacity>
                  )}
                </View>
              </View>
              ...
              <View style={styles.recipeDetails}>
                ...
                {color.active === "Instructions" && (
                  <>
                    ...
                    {recipe.notes[0].id !== null &&
                      recipe.notes.map((note, i) => (
                        <DisplayRecipeNotes key={i} notes={note} index={i} />
                      ))}
                  </>
                )}
              </View>
